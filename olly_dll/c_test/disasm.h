...
int    __stdcall Assemble(char *cmd,ulong ip,t_asmmodel *model,int attempt,
...
ulong  __stdcall Disasm(char *src,ulong srcsize,ulong srcip, t_disasm *disasm,int disasmmode);
